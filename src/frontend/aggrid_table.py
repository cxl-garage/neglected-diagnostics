...
def aggrid_table() -> Dict:
    ...
    Notes
    -----
    1. Before calling this function, ensure that you have stored your DataFrame in the
    ...
    2. `enable_enterprise_modules` should be set to False to be eligible to use the Open-Source version of `aggrid`. Refer here for more details - https://www.ag-grid.com/javascript-data-grid/licensing/
    """
